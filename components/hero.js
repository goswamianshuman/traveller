      ...
      <Container>
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around">
            <div className="pt-2 text-neutral-900 dark:text-neutral-900">
              <AmazonLogo />
            </div>
            <div className="text-neutral-900 dark:text-neutral-900">
              <VerizonLogo />
            </div>
            <div className="text-neutral-900 dark:text-neutral-900">
              <MicrosoftLogo />
            </div>
            <div className="pt-1 text-neutral-900 dark:text-neutral-900">
              <NetflixLogo />
            </div>
            <div className="pt-2 text-neutral-900 dark:text-neutral-900">
              <SonyLogo />
