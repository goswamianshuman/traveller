        ...
        <div>
          <div className="flex flex-col w-full mt-4">
            ...
            <p className="max-w-2xl py-4 text-lg leading-normal text-trueGray-600 lg:text-xl xl:text-xl dark:text-gray-300">
              ...
              friendly person who can accompany you to the places you would like
              to visit, and things you would like to do.
            </p>

            <p className="max-w-2xl py-4 text-base leading-normal text-voilet-600 lg:text-lg xl:text-lg dark:text-voilet-600">
